...
namespace _qt_qml_MyCalculator_ModeSelector_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_MyCalculator_ChildrenSelector_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_MyCalculator_PensionButton_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_MyCalculator_CalculatorGridPA_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/MyCalculator/ModeSelector.qml"), &QmlCacheGeneratedCode::_qt_qml_MyCalculator_ModeSelector_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/MyCalculator/ChildrenSelector.qml"), &QmlCacheGeneratedCode::_qt_qml_MyCalculator_ChildrenSelector_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/MyCalculator/PensionButton.qml"), &QmlCacheGeneratedCode::_qt_qml_MyCalculator_PensionButton_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/MyCalculator/CalculatorGridPA.qml"), &QmlCacheGeneratedCode::_qt_qml_MyCalculator_CalculatorGridPA_qml::unit);
